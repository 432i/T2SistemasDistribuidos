...
type Chunk struct {
	...
	Datos []byte `protobuf:"bytes,1,opt,name=datos,proto3" json:"datos,omitempty"`
}
...
var file_serverCliDN_proto_rawDesc = []byte{
	,
...
var file_serverCliDN_proto_goTypes = []interface{}{
	(*Chunk)(nil),   // 0: connclidn.Chunk
	(*Message)(nil), // 1: connclidn.Message
}
var file_serverCliDN_proto_depIdxs = []int32{
	0, // 0: connclidn.ChatCliDn.ChunkaDN:input_type -> connclidn.Chunk
	1, // 1: connclidn.ChatCliDn.ChunkaDN:output_type -> connclidn.Message
...
func (c *chatCliDnClient) ChunkaDN(ctx context.Context, in *Chunk, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/connclidn.ChatCliDn/ChunkaDN", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChatCliDn_ChunkaDN_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connclidn.ChatCliDn/ChunkaDN",
	}
...
var _ChatCliDn_serviceDesc = grpc.ServiceDesc{
	ServiceName: "connclidn.ChatCliDn",
